...
public class MapperPlusPlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        baseMapperInterface.addAnnotation("@Mapper");
    ...
    private void addUpdateByExampleSelective(Interface interfaze) {
        // int updateByExampleSelective(@Param("record") T row, @Param("example") E example);
        ...
        rowParam.addAnnotation("@Param(\"record\")");
    ...
    private void addUpdateByExample(Interface interfaze) {
        // int updateByExample(@Param("record") T row, @Param("example") E example);
